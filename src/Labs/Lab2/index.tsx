...
export default function Lab2() {
  return (
    <div id="wd-lab2">
      ...
      {/* Add a new section with a heading "ID selectors" */}
      ...
      {/* Add a new section with a heading "Class selectors" */}
      ...
      {/* Add a new section with a heading "Document structure selectors" */}
